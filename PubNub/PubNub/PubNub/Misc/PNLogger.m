...
struct PNLoggerSymbolsStructure PNLoggerSymbols = {
    ...
    .connectionChannel = {
        ...
        .service = {
            ...
            .remoteObjectDataFetchRequestCompleted = @"0202051",
            .remoteObjectDataFetchRequestFailed = @"0202052",
            .remoteObjectNextPortionOfDataFetchRequestCompleted = @"0202053",
            .remoteObjectNextPortionOfDataFetchRequestFailed = @"0202054",
            .remoteObjectDataPushRequestCompleted = @"0202055",
            .remoteObjectDataPushRequestFailed = @"0202056",
            .remoteObjectDataPushToListRequestCompleted = @"0202057",
            .remoteObjectDataPushToListRequestFailed = @"0202058",
            .remoteObjectDataReplaceRequestCompleted = @"0202059",
            .remoteObjectDataReplaceRequestFailed = @"0202060",
            .remoteObjectDataRemoveRequestCompleted = @"0202061",
            .remoteObjectDataRemoveRequestFailed = @"0202062",
        }
    },
    .requests = {
    ...
    .api = {
        ...
        .remoteObjectSynchronizationStartAttempt = @"0900289",
        .remoteObjectSynchronizationStart = @"0900290",
        .remoteObjectSynchronizationStartImpossible = @"0900291",
        .postponeRemoteObjectSynchronizationStart = @"0900292",
        .remoteObjectSynchronizationStartCompleted = @"0900293",
        .remoteObjectSynchronizationStartFailed = @"0900294",
        .remoteObjectSynchronizationStopAttempt = @"0900295",
        .remoteObjectSynchronizationStop = @"0900296",
        .remoteObjectSynchronizationStopImpossible = @"0900297",
        .postponeRemoteObjectSynchronizationStop = @"0900298",
        .remoteObjectSynchronizationStopCompleted = @"0900299",
        .remoteObjectSynchronizationStopFailed = @"0900300",
        
        .remoteObjectDataFetchAttempt = @"0900301",
        .remoteObjectDataFetch = @"0900302",
        .remoteObjectDataFetchImpossible = @"0900303",
        .postponeRemoteObjectDataFetch = @"0900304",
        .remoteObjectDataFetchCompleted = @"0900305",
        .remoteObjectDataFetchFailed = @"0900306",
        .rescheduleRemoteObjectDataFetch = @"0900307",
        .remoteObjectDataPortionFetchAttempt = @"0900308",
        .remoteObjectDataPortionFetch = @"0900309",
        .remoteObjectDataPortionFetchImpossible = @"0900310",
        .postponeRemoteObjectDataPortionFetch = @"0900311",
        .remoteObjectDataPortionFetchCompleted = @"0900312",
        .remoteObjectDataPortionFetchFailed = @"0900313",
        .rescheduleRemoteObjectDataPortionFetch = @"0900314",
        
        
        .remoteObjectDataPushAttempt = @"0900315",
        .remoteObjectDataPush = @"0900316",
        .remoteObjectDataPushImpossible = @"0900317",
        .postponeRemoteObjectDataPush = @"0900318",
        .remoteObjectDataPushCompleted = @"0900319",
        .remoteObjectDataPushFailed = @"0900320",
        .rescheduleRemoteObjectDataPush = @"0900321",
        
        .remoteObjectDataPushToListAttempt = @"0900322",
        .remoteObjectDataPushToList = @"0900323",
        .remoteObjectDataPushToListImpossible = @"0900324",
        .postponeRemoteObjectDataPushToList = @"0900325",
        .remoteObjectDataPushToListCompleted = @"0900326",
        .remoteObjectDataPushToListFailed = @"0900327",
        .rescheduleRemoteObjectDataPushToList = @"0900328",
        
        .remoteObjectDataReplaceAttempt = @"0900329",
        .remoteObjectDataReplace = @"0900330",
        .remoteObjectDataReplaceImpossible = @"0900331",
        .postponeRemoteObjectDataReplace = @"0900332",
        .remoteObjectDataReplaceCompleted = @"0900333",
        .remoteObjectDataReplaceFailed = @"0900334",
        .rescheduleRemoteObjectDataReplace = @"0900335",
        
        .remoteObjectDataRemoveAttempt = @"0900336",
        .remoteObjectDataRemove = @"0900337",
        .remoteObjectDataRemoveImpossible = @"0900338",
        .postponeRemoteObjectDataRemove = @"0900339",
        .remoteObjectDataRemoveCompleted = @"0900340",
        .remoteObjectDataRemoveFailed = @"0900341",
        .rescheduleRemoteObjectDataRemove = @"0900342",
    },
    .observationCenter = {
